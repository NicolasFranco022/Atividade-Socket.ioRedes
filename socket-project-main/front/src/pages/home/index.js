...
// IMPORTA A IMAGEM — assumindo que imagem-fundo.jpg está na MESMA PASTA deste arquivo
import bgImage from './imagem-fundo.jpg';
...
export default function Login() {
    ...
    // Estilo inline usando a imagem importada — isso garante que o bundler ache o arquivo
    const backgroundStyle = {
        backgroundImage: `url(${bgImage})`
    };

    return (
        <div className="tela" style={backgroundStyle}>
            {/* overlay escuro para garantir legibilidade do conteúdo */}
            <div className="tela-overlay" />
